...
public class FormCopia extends JPanel {
	...
	public FormCopia() {
		...
		cbzFitoFerti = new JComboBox();
		cbzFitoFerti.setPreferredSize(new Dimension(300, 20));
		cbzFitoFerti.setFont(new Font("Calibri", Font.PLAIN, 16));
		cbzFitoFerti.setBounds(215, 227, 249, 20);
		panelRegistro.add(cbzFitoFerti);
		...
		btnAgregar.setBounds(25, 334, 100, 40);
		...
		btnRegresar.setBounds(148, 334, 100, 40);
