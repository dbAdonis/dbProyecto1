...
public class Menu extends JPanel {
	...
	public Menu() {
		...
		btnGestionarPersonal.setFont(new Font("SansSerif", Font.BOLD, 14));
		...
		btnReportesDiarios.setFont(new Font("SansSerif", Font.BOLD, 14));
		...
		ImageIcon iconImgForm = new ImageIcon(imgForm.getImage().getScaledInstance(90, 81, Image.SCALE_DEFAULT));
		...
		ImageIcon iconImgProductos = new ImageIcon(imgProductos.getImage().getScaledInstance(90, 81, Image.SCALE_DEFAULT));
